...
namespace PemImport
{
    public class Certificate
    {
        ...
        public static X509Certificate2 GetCertificateWithKeyFromPEMstring(string publicCertAndPrivateKey, string password)
        {
            byte[] certBuffer = Helpers.GetBytesFromPEM(publicCertAndPrivateKey, PemStringType.Certificate);
            byte[] keyBuffer = Helpers.GetBytesFromPEM(publicCertAndPrivateKey, PemStringType.RsaPrivateKey);
